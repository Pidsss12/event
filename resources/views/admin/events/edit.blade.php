    ...
    <div class="event-card">
        ...
        <div class="event-header">
            <div style="position:relative; z-index:1;">
                ...
                <h1 style="font-size:24px; font-weight:900; margin-top:4px; font-family:'Outfit',sans-serif;">Edit Agenda Event</h1>
            </div>
            <div style="width:48px; height:48px; background:rgba(255,255,255,0.1); backdrop-filter:blur(10px); border-radius:14px; display:flex; align-items:center; justify-content:center;">
                <i data-lucide="edit-3" style="width:22px; height:22px; color:white;"></i>
            </div>
        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="form-group md:col-span-2">
                            ...
                            <textarea name="description" id="description" rows="5" required
                                      ...
                                      placeholder="Tuliskan deskripsi lengkap agenda, pembicara, dan benefit dari event ini...">{{ old('description', $event->description) }}</textarea>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div class="ticket-tier-card tier-silver">
                            ...
                            <div class="space-y-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="silver_price" required value="{{ old('silver_price', $silver ? $silver->price : 150000) }}" min="0" class="form-input" style="padding:10px 12px; font-size:13px;">
                                </div>
                                <div class="form-group">
                                    <label class="form-label" style="font-size:9px;">Kapasitas Kursi</label>
                                    <input type="number" name="silver_capacity" required value="{{ old('silver_capacity', $silver ? $silver->capacity : 100) }}" min="1" class="form-input" style="padding:10px 12px; font-size:13px;">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="ticket-tier-card tier-gold">
                            ...
                            <div class="space-y-4">
                                <div class="form-group">
                                    <label class="form-label" style="font-size:9px;">Harga (Rp)</label>
                                    <input type="number" name="gold_price" required value="{{ old('gold_price', $gold ? $gold->price : 350000) }}" min="0" class="form-input" style="padding:10px 12px; font-size:13px;">
                                </div>
                                <div class="form-group">
                                    <label class="form-label" style="font-size:9px;">Kapasitas Kursi</label>
                                    <input type="number" name="gold_capacity" required value="{{ old('gold_capacity', $gold ? $gold->capacity : 50) }}" min="1" class="form-input" style="padding:10px 12px; font-size:13px;">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="ticket-tier-card tier-platinum">
                            ...
                            <div class="space-y-4">
                                <div class="form-group">
                                    <label class="form-label" style="font-size:9px;">Harga (Rp)</label>
                                    <input type="number" name="platinum_price" required value="{{ old('platinum_price', $platinum ? $platinum->price : 750000) }}" min="0" class="form-input" style="padding:10px 12px; font-size:13px;">
                                </div>
                                <div class="form-group">
                                    <label class="form-label" style="font-size:9px;">Kapasitas Kursi</label>
                                    <input type="number" name="platinum_capacity" required value="{{ old('platinum_capacity', $platinum ? $platinum->capacity : 20) }}" min="1" class="form-input" style="padding:10px 12px; font-size:13px;">
                                </div>
                            </div>
                        </div>
